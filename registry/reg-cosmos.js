/* ============================================================
   SOLAR registry — reg-cosmos.js
   Registry-parity cosmic ground: the same violet/blue nebula + twinkle
   starfield as the workbench (js/ui/space-bg.js), rendered as a fixed
   full-viewport layer BEHIND the masthead and .main. Kept quiet
   (nebula ≤0.08) so the solid glass panels/cards read on top.
   Hidden in light theme (the cosmic brand lives in dark mode).
   pointer-events none; honours prefers-reduced-motion.
   ============================================================ */
(function () {
  "use strict";
  ...
  function seed() {
    ...
    /* same violet/blue gas masses as the workbench (space-bg.js), at a lower
       alpha so the nebula wash stays ≤0.08 per the registry-parity contract */
    blobs = [
  ...
  function frame(now) {
    ...
    /* light theme: the ground is the cream canvas — no cosmic nebula */
